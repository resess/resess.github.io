## UC11: Start Voting Session 

This document provides a detailed description of the use case UC11: Start Voting Session.
...
5. The system calls the [UC6: ‘View Details of a Group’](UC6_View_Details_of_a_Group.md), displaying the Group Details screen. 
