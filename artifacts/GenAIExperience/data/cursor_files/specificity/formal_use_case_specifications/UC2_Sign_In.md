...
This document provides a detailed description of use case UC2: Sign In. 
...
An existing user authenticates using External Authentication Service (Google Authentication Service). 
...
5b. User does not exist.

- 5b2. The system displays an error message "User not found. Please sign up first."  
