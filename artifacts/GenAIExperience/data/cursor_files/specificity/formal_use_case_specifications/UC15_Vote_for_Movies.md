## UC15: Vote for Movies 

This document provides a detailed description of the use case UC13: Vote for Movies.
...
5. If no movie cards are left, the system  presents a confirmation message for finishing voting for all movies and then calls the [UC6: ‘View Details of a Group’](UC6_View_Details_of_a_Group.md), displaying the Group Details screen.
...
- 1a2. The system calls the [UC6: ‘View Details of a Group’](UC6_View_Details_of_a_Group.md), displaying the Group Details screen, with the updated voting session state.
