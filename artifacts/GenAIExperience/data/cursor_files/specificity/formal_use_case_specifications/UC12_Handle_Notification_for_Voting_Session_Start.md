## UC12: Handle Notification for Voting Session Start

This document provides a detailed description of the use case UC13: Handle Notification for Voting Session Start. 
...
1. The system opens the app and calls the [UC6: ‘View Details of a Group’](UC6_View_Details_of_a_Group.md), displaying the Group Details screen. 
