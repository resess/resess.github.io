// Navigation configuration for the AMDToolEvaluation artifact pages
...
const navigationConfig = {
    items: [
        ...
        },
        {
            ...
            href: "docs/literature_review.html",
            path: "docs/literature_review.html"
        },
        {
            title: "Paper Categorization",
            href: "docs/paper_categorization.html",
            path: "docs/paper_categorization.html"
        },
        {
            title: "Dataset",
            href: "docs/dataset.html",
            path: "docs/dataset.html"
        },
        {
            title: "Evaluation Package",
            href: "docs/evaluation_package.html",
            path: "docs/evaluation_package.html"
        },
        {
            title: "Results",
            href: "docs/results.html",
            path: "docs/results.html"
        },
        {
            title: "Ablation Studies",
            href: "docs/ablation_studies.html",
            path: "docs/ablation_studies.html"
        }
    ]
};
...
function getCurrentPagePath() {
    ...
    // Try to find the AMDToolEvaluation directory in the path
    const siteIndex = path.indexOf('/artifacts/AMDToolEvaluation/');
    if (siteIndex !== -1) {
        const pathname = path.substring(siteIndex + '/artifacts/AMDToolEvaluation/'.length);
